...
#'
#' @param feature_to_plot Model object to create coefficient table for. Must be of type: \link[stats:glm]{stats::glm()}, \link[stats:lm]{stats::lm()},  \link[parsnip:linear_reg()]{parsnip::linear_reg()}, \link[parsnip:logistic_reg()]{parsnip::logistic_reg()} or  \link[poissonreg:poisson_reg()]{poissonreg::poisson_reg()}
...
#' @param return_data Set to TRUE to return dataset instead of plot
#'
...
#   # Create plots  --------------------------------------------------------------------------------
#   p <- plot_data %>%
#     ggplot2::ggplot(ggplot2::aes(x=Level, y=value, group = name, colour = name, linetype = name)) +
#     ggplot2::geom_point(ggplot2::aes(size = name)) +#col='black', fill='black') +
#     ggplot2::geom_line() +
#     ggplot2::theme_minimal() +
#     ggplot2::scale_colour_manual(values = c("black", "grey", "grey"), limits = c('Relativity', 'Approx_Upper_95CI', 'Approx_Lower_95CI')) +
#     ggplot2::scale_size_manual(values = c(2,0,0), limits = c('Relativity', 'Approx_Upper_95CI', 'Approx_Lower_95CI')) +
#     ggplot2::scale_linetype_manual(values = c('solid', 'dashed', 'dashed'), limits = c('Relativity', 'Approx_Upper_95CI', 'Approx_Lower_95CI')) +
#     ggplot2::ggtitle(paste('Relativities for', feature_to_plot)) +
#     ggplot2::xlab(feature_to_plot) +
#     ggplot2::ylab('Relativity') +
