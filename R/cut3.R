#' @title cut3
#'
#' @description Copy of `Hmisc::cut2()` to reduce dependency on `survival` package. Function like cut but left endpoints are inclusive and labels are of the form [lower, upper), except that last interval is [lower,upper].
#'
#' @param x description
...
#' @param minmax description
#' @param oneval description
#' @param onlycuts description
#' @param formatfun description
#'
#' @return
#'
#' @examples
...
#'   dplyr::mutate(age_cat = cut3(age, g=30, levels.mean=TRUE))
#'
#' @author F. Harrell
#'
#' @export
