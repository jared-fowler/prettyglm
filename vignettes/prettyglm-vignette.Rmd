...
By default `pretty_coefficients` shows "model" variable importance. But `vimethod` also accepts "permute" and "firm" methods from \link[vi]{vip}. Additional parameters for these methods should also be passed into `pretty_coefficients`.
...
For splines to work nicely in `prettyglm` use the naming convention Variable#Start#End where # represents your desired seperator.
